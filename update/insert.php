...
if (isset($_POST['submit'])) {
    if (isset($_POST['newemail']) && isset($_POST['newpassword']) && isset($_POST['ad']) && isset($_POST['pk']) &&
...
$conn = new mysqli($cleardb_server, $cleardb_username, $cleardb_password, $cleardb_db);
        ...
        if ($conn->connect_error) {
            ...
            $Insert = "INSERT INTO signup(Username, Password1, Email, Address1, Priv) values(?, ?, ?, ?, ?)";
            ...
            if ($rnum == 0) {
                ...
                $stmt->bind_param("sssss",$username, $password, $email, $address, $pk);
                if ($stmt->execute()) {
